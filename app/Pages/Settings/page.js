    ...
    return (
      <div className='px-4 py-8'>
          <div className='flex flex-col p-4 gap-4 items-center max-w-[400px] m-auto'>
              ...
              <input onChange={e=>{console.log('changed')}} type='text' placeholder='Name' value={session?.user.name} className='w-full p-2 text-lg text-center border rounded-md shadow-xl'/>
